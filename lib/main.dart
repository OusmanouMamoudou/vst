// Ce code configure notre application Flutter,
...
import 'package:vst/screens/home.dart'; // Importation de l'écran d'accueil
import 'package:vst/services/datas.dart'; // Importation des services de données
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(
      context,
    ).size; // Récupération de la taille de l'écran
    ...
    return ChangeNotifierProvider<Datas>(
      ...
      builder: (context, child) => MaterialApp(
        ...
        title: 'VST', // Titre de l'application
        theme: ThemeData(
          // Thème de l'application
          colorScheme: ColorScheme.fromSeed(
            seedColor: kBackgroundColor,
          ), // Schéma de couleurs basé sur la couleur d'arrière-plan
          textTheme: const TextTheme(
            // Thèmes de texte
            bodyLarge: TextStyle(
              color: kTextColor,
            ), // Style de texte pour les corps de grande taille
            bodyMedium: TextStyle(
              color: kTextColor,
            ), // Style de texte pour les corps de taille moyenne
            bodySmall: TextStyle(
              color: kTextColor,
            ), // Style de texte pour les petits corps
          ),
        ...
        home: Consumer<Datas>(
          builder: (context, datas, child) {
            ...
            datas
                .fetchVideos(); // Appel de la méthode pour récupérer les tutoriels
