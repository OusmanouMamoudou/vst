...
import 'package:vst/const.dart'; // Import des constantes
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Flexible(
                      child: Text("Author:   $author", style: textStyle),
                    ),
                    IconButton(
                      icon: Icon(
                        Icons.open_in_new,
                      ...
                      onPressed: () async {
                        await Share.share(
                          url.toString(),
                        ); // Partager l'URL de l'article lorsqu'on appuie sur l'icône
                      },
                    ),
                  ],
                ),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Flexible(
                    child: Text("Source: $sourceName", style: textStyle),
                  ),
                  Text(
